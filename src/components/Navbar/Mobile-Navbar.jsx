...
export default function MobileNavbar() {
    ...
    return (
        <div className="container-wrapper">
            ...
            <div className={`absolute z-100 right-4 mt-2 w-56 rounded-2xl backdrop-blur-md bg-[#1a0800] border border-white/10 p-6 flex flex-col gap-4 transition-all duration-300 ${isOpen ? "opacity-100 translate-y-0 pointer-events-auto" : "opacity-0 -translate-y-2 pointer-events-none"}`}>
